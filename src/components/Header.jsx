            ...
            <div className='flex items-center gap-x-2.5 text-2xl relative select-none'>
                ...
                {showSearch && (
                    <div className='absolute -bottom-12 right-8 md:hidden'>
                        ...
                        <input placeholder='Search...' type="text" onChange={e => searchHandler(e)} className='bg-zinc-300 dark:bg-white outline-none border-none rounded-md w-60 h-9 p-2 text-sm text-black dark:text-cus-white-400 placeholder:text-cus-white-400' />
                    </div>
                )}
                <input placeholder='Search...' type="text" onChange={e => searchHandler(e)} className='bg-zinc-300 dark:bg-white/90 outline-none border-none rounded-md px-4 py-2 w-64 text-sm hidden md:block text-black dark:text-cus-white-400 placeholder:text-cus-white-400' />
